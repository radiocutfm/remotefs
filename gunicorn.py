...
def setup_hooks():
    ...
    hooks = "on_starting,on_reload,when_ready,pre_fork,post_fork,post_worker_init,worker_int,worker_abort,pre_exec,pre_request,post_request,child_exit,worker_exit,nworkers_changed,on_exit"
